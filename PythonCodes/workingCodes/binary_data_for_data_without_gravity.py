...
with open('imu_data_without_gravity.csv', 'w', newline='') as csvfile:
    fieldnames = ['Timestamp', 'linear_accelerationX', 'linear_accelerationY', 'linear_accelerationZ', 'magX', 'magY', 'magZ', 'gyroX', 'gyroY', 'gyroZ']
