...
BLECharacteristic imuCharacteristic("87654321-4321-4321-4321-cba987654321", 
                                     BLERead | BLENotify, 48); // Characteristic size (9 floats)
    ...
    while (central.connected()) {
      ...
      if (IMU.accelerationAvailable() && IMU.magneticFieldAvailable() && IMU.gyroscopeAvailable()) {
       ...
       /* for (int i = 0; i < 3; i++) {
        ...
        Serial.print(" ");
        Serial.print(linear_acceleration[2]);
        Serial.print(" ");
        Serial.print(magX);
        Serial.print(" ");
        Serial.print(magY);
        ...
        memcpy(imuData + 36, &accX, sizeof(accX));
        memcpy(imuData + 40, &accY, sizeof(accY));
        memcpy(imuData + 44, &accZ, sizeof(accZ));
